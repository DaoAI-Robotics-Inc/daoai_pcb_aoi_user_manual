...
.. screenshot-todo: images/models_dataset_page.png — 数据集视图，展示图像库、右侧训练/测试分布面板及顶部按钮
...
.. screenshot-todo: images/models_train_page.png — 训练视图，展示左侧训练设置面板（标签统计表）、右侧摘要面板（混淆矩阵）及底部开始训练按钮
